...
date: "12/15/2018"
params:
  id: "410672058（留意要與studentID:間空一格）"
  name: "吳怡萱（留意要與name:間空一格）"
...
```{r ans16}
hwGrades %>% mutate(
  作業平均成績=mean(c('hw1','hw2','Exercise3'))
)
```
