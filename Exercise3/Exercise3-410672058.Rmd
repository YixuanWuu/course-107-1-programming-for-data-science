...
classData$`公-10-06`<-str_replace(classData$`公-10-06`,"1","有看公告")
classData$`公-10-06`<-str_replace(classData$`公-10-06`,"0","沒看公告")
```
...
```{r ans13}
a<-table(yes$`練2018-10-17-1`=="1")
paste(round(a[2]/sum(a),4)*100,"%")
```
